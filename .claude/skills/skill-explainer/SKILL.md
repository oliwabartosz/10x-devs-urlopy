...
description: Analyze a skill to understand its mechanics, design rationale, and how to build something similar. Use when the user says "explain skill", "how does this skill work", "demystify skill", "analyze skill", "skill explainer", or provides a skill name and wants to understand it.
allowed-tools:
  - Read
  - Bash
---
