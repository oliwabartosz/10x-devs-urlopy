...
- [x] 4.1 Type checking and linting pass: `npm run lint` — 0 errors repo-wide; `astro check` 0 errors over 127 files — 124eb47
- [x] 4.2 Production build succeeds: `npm run build` — 124eb47
- [x] 4.3 Existing suite still green: `npm run test:run` — 21 files, 238/238 — 124eb47
...
- [x] 6.1 New E2E spec passes against a deployed target: `npm run e2e` — 3/3 incl. setup — 56f0cb3
- [x] 6.2 Existing E2E specs still pass: `npm run e2e` — 8/8 repo-wide — 56f0cb3
- [x] 6.3 Linting passes: `npm run lint` — 0 errors — 56f0cb3

#### Manual

- [x] 6.4 The new spec passes on a re-run without flaking — 3 consecutive green runs — 56f0cb3
- [x] 6.5 `e2e-rules.md` states the testid scheme precisely enough to follow without reading the component — 56f0cb3
- [x] 6.6 `AGENTS.md:9` no longer denies the E2E setup exists — 56f0cb3
