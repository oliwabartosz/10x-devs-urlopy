...
- [ ] 1.1 Migration applies without errors (`npx supabase migration up` or `db reset`)
- [ ] 1.2 `npm run build` passes (Drizzle types propagate)
- [ ] 1.3 `npm run lint` passes

#### Manual

- [ ] 1.4 `supabase db diff` shows column swap and updated CHECK; no unintended changes
